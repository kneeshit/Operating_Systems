...
00000000 <toggle1>:
      ...
      14:	eb0001b1 	bl	6e0 <acquireLock>
      ...
      7c:	eb0001ab 	bl	730 <releaseLock>
      80:	eb000320 	bl	d08 <thread_exit>
      84:	e3a03000 	mov	r3, #0
      88:	e1a00003 	mov	r0, r3
      8c:	e24bd004 	sub	sp, fp, #4
      90:	e8bd8800 	pop	{fp, pc}
      94:	000016b4 	.word	0x000016b4
      98:	000016bc 	.word	0x000016bc
      9c:	00001678 	.word	0x00001678
...
000000a0 <toggle2>:
      ...
      b4:	eb000189 	bl	6e0 <acquireLock>
     ...
     11c:	eb000183 	bl	730 <releaseLock>
     120:	eb0002f8 	bl	d08 <thread_exit>
     124:	e3a03000 	mov	r3, #0
     128:	e1a00003 	mov	r0, r3
     12c:	e24bd004 	sub	sp, fp, #4
     130:	e8bd8800 	pop	{fp, pc}
     134:	000016b4 	.word	0x000016b4
     138:	000016bc 	.word	0x000016bc
     13c:	00001688 	.word	0x00001688
...
00000140 <main>:
     ...
     158:	eb000180 	bl	760 <initiateCondVar>
     ...
     174:	eb0002da 	bl	ce4 <thread_create>
     178:	e24b2008 	sub	r2, fp, #8
     17c:	e24b3010 	sub	r3, fp, #16
     180:	e59f102c 	ldr	r1, [pc, #44]	@ 1b4 <main+0x74>
     184:	e1a00003 	mov	r0, r3
     188:	eb0002d5 	bl	ce4 <thread_create>
     18c:	e51b300c 	ldr	r3, [fp, #-12]
     190:	e1a00003 	mov	r0, r3
     194:	eb0002e4 	bl	d2c <thread_join>
     198:	e51b3010 	ldr	r3, [fp, #-16]
     19c:	e1a00003 	mov	r0, r3
     1a0:	eb0002e1 	bl	d2c <thread_join>
     1a4:	eb0001ed 	bl	960 <exit>
     1a8:	000016b4 	.word	0x000016b4
     1ac:	000016bc 	.word	0x000016bc
...
000013f8 <malloc>:
    ...
    1558:	000016cc 	.word	0x000016cc
    155c:	000016c4 	.word	0x000016c4
