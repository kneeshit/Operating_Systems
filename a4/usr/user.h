...
// Thread and synchronization syscalls from xv6
...
// Synchronization primitives from xv6
struct lock{
    int lockvar;
    int isInitiated;
};
...
// keep prototype *after* struct uproc is defined
int getprocs(struct uproc *buf, int n);

// Synchronization function prototypes from xv6
